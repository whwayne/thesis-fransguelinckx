...
public class CFClientSecure extends Activity {
    static {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_AUTH_COMPLETE:
                ...
                if (authenticated.equals(Boolean.FALSE)) {
                    Toast.makeText(CFClientSecure.this, "Authentication failed", Toast.LENGTH_LONG).show();
                }
                break;
            ...
            case MESSAGE_START_PROGRESS_DIALOG:
                mDialog = ProgressDialog.show(CFClientSecure.this, 
                                              "", 
    ...
    class BusHandler extends Handler {        
        ...
        private CFTabletopServiceInterfaceSecure mSecureInterface;
            ...
            case (JOIN_SESSION): {
                ...
                if (status == Status.OK) {
                	...
                	mProxyObj =  mBus.getProxyBusObject(SERVICE_NAME, 
                										"/SecureService",
                										sessionId.value,
                										new Class[] { CFTabletopServiceInterfaceSecure.class });

                	/* We make calls to the methods of the AllJoyn object through one of its interfaces. */
                	mSecureInterface = mProxyObj.getInterface(CFTabletopServiceInterfaceSecure.class);
