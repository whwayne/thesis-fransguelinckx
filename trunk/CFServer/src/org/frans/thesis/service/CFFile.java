...
/**
 * This class represents a file coming from mobile devices. It holds te file itself and the location of the file in the file system of the mobile device.
 */
public class CFFile {
	 ...
	 * @param path
	 * The location of the file in the file system of the mobile device.
	 * @param file
	 * The file itself
	 */
